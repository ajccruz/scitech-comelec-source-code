...
webkit_dom_html_media_element_add_text_track(WebKitDOMHTMLMediaElement* self, const gchar* kind, const gchar* label, const gchar* language, GError** error);
 ...
 * @self: A #WebKitDOMHTMLMediaElement
 *
 * Returns: (transfer full): A #WebKitDOMAudioTrackList
**/
WEBKIT_API WebKitDOMAudioTrackList*
webkit_dom_html_media_element_get_audio_tracks(WebKitDOMHTMLMediaElement* self);

/**
 * webkit_dom_html_media_element_get_text_tracks:
 * @self: A #WebKitDOMHTMLMediaElement
 *
 * Returns: (transfer none): A #WebKitDOMTextTrackList
**/
WEBKIT_API WebKitDOMTextTrackList*
webkit_dom_html_media_element_get_text_tracks(WebKitDOMHTMLMediaElement* self);

/**
 * webkit_dom_html_media_element_get_video_tracks:
 * @self: A #WebKitDOMHTMLMediaElement
 *
 * Returns: (transfer none): A #WebKitDOMVideoTrackList
**/
WEBKIT_API WebKitDOMVideoTrackList*
webkit_dom_html_media_element_get_video_tracks(WebKitDOMHTMLMediaElement* self);
