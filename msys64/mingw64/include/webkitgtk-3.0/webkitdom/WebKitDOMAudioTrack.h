...
#define WEBKIT_DOM_AUDIO_TRACK_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_TYPE_DOM_AUDIO_TRACK, WebKitDOMAudioTrackClass)
#define WEBKIT_DOM_IS_AUDIO_TRACK(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), WEBKIT_TYPE_DOM_AUDIO_TRACK))
#define WEBKIT_DOM_IS_AUDIO_TRACK_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),  WEBKIT_TYPE_DOM_AUDIO_TRACK))
