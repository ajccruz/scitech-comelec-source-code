...
#define WEBKIT_DOM_TEXT_TRACK_LIST_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_TYPE_DOM_TEXT_TRACK_LIST, WebKitDOMTextTrackListClass)
#define WEBKIT_DOM_IS_TEXT_TRACK_LIST(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), WEBKIT_TYPE_DOM_TEXT_TRACK_LIST))
#define WEBKIT_DOM_IS_TEXT_TRACK_LIST_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),  WEBKIT_TYPE_DOM_TEXT_TRACK_LIST))
...
/**
 * webkit_dom_text_track_list_dispatch_event:
 * @self: A #WebKitDOMTextTrackList
