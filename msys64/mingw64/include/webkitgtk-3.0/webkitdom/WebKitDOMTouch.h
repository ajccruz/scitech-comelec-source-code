...
#define WEBKIT_DOM_TOUCH_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_TYPE_DOM_TOUCH, WebKitDOMTouchClass)
#define WEBKIT_DOM_IS_TOUCH(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), WEBKIT_TYPE_DOM_TOUCH))
#define WEBKIT_DOM_IS_TOUCH_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),  WEBKIT_TYPE_DOM_TOUCH))
