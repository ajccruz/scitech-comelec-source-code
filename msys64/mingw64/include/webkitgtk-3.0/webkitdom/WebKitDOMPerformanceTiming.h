...
#define WEBKIT_DOM_PERFORMANCE_TIMING_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_TYPE_DOM_PERFORMANCE_TIMING, WebKitDOMPerformanceTimingClass)
#define WEBKIT_DOM_IS_PERFORMANCE_TIMING(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), WEBKIT_TYPE_DOM_PERFORMANCE_TIMING))
#define WEBKIT_DOM_IS_PERFORMANCE_TIMING_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass),  WEBKIT_TYPE_DOM_PERFORMANCE_TIMING))
