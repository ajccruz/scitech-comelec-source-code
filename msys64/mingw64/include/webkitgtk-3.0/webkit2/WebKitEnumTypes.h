...
/* Enumerations from WebKitNavigationPolicyDecision.h. */
...
#define WEBKIT_TYPE_VIEW_MODE webkit_view_mode_get_type ()

WEBKIT_API GType
webkit_view_mode_get_type (void);
...
/* Enumerations from WebKitWebViewGroup.h. */
#define WEBKIT_TYPE_INJECTED_CONTENT_FRAMES webkit_injected_content_frames_get_type ()

WEBKIT_API GType
webkit_injected_content_frames_get_type (void);
