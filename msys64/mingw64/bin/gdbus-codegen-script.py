#!//LAPTOP-PO15ASV2/Users/Nouwenlianmarien/Desktop/KALAT/msys64/mingw64/bin/python3.exe
...
if not os.path.isfile(os.path.join(path, 'codegen', 'codegen_main.py')):
    path = os.path.join('//LAPTOP-PO15ASV2/Users/Nouwenlianmarien/Desktop/KALAT/msys64/mingw64/share', 'glib-2.0')
